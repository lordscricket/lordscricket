...
describe('RequestHelpers', () => {
    it('should return a valid user agent from getUserAgent ', () => {
        ...
        (0, TestHelper_1.default)(res).to.include.members(expected);
    });
    it('getAgent() should return undefined when no env variable is set', () => {
        ...
        (0, TestHelper_1.default)(res).to.be.undefined;
    });
    it('getAgent() should return a proxy httpAgent when env variable is set', () => {
        process.env.http_proxy = 'http://test.local:8080';
        const res = RequestHelpers_1.RequestHelpers.getAgent();
        (0, TestHelper_1.default)(res).not.to.be.undefined;
        if (res) {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            (0, TestHelper_1.default)(res.proxy.host).to.equal('test.local');
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            (0, TestHelper_1.default)(res.proxy.port).to.equal(8080);
        }
    });
    it('getAgent() should return an insecure httpAgent', () => {
        ...
        if (res) {
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            (0, TestHelper_1.default)(res.options.rejectUnauthorized).to.equal(false);
        }
    });
